class compareInputs:
    ...
    def greater_than(self):
        return f'{self.value1} greater than {self.value2}' if self.value1 > self.value2 else \
               f'{self.value2} greater than {self.value1}'
    
    def equal(self):
        return f'{self.value1} equal to {self.value2}' if self.value1 == self.value2 else \
               f'{self.value1} is not equal to {self.value2}'
    
    def less_than(self):
        return f'{self.value1} less than {self.value2}' if self.value1 > self.value2 else \
               f'{self.value2} less than {self.value1}'
